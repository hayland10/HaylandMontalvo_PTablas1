...
namespace HaylandMontalvo_PTablas1.Controllers
{
    public class BurgersController : Controller
    {
        private readonly HaylandMontalvo_PTablas1Context _context;

        public BurgersController(HaylandMontalvo_PTablas1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'HaylandMontalvo_PTablas1Context.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HaylandMontalvo_PTablas1Context.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
